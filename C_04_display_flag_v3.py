...
for item in range(0, 20):
    ...
    # Resize the flag image to fit the label dimensions
    ...
    # Create a label to display a clue about the correct answer
    clue_label = Label(root, text=f"Clue: The capital is {question_flags[current_correct_answer][1]}!", wrap=350)
    clue_label.grid(row=3)  # Position the clue label below the flag image
